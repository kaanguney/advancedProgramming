#include <iostream>
#include "myboard.h"   //change this with your header file name
#include "players.h"  //change this with your header file name

using namespace std;

void shipPlacement(myboard &theBoard, int playerID, int shipID)
{
...
int main()
{
    ...
    players player1 = players(myBoard, 1);
    cout << "Player 1 registered to the game." << endl;
    players player2 = players(myBoard, 2);
